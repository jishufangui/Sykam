<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Mod.aspx.cs" Inherits="Web.operate.Admin_Mod" %>
...
<body>
 ...
 <br />
            <table cellpadding="3" cellspacing="1" border="0" width="100%" align="center">
                <tr>
                    <td colspan="2" class="td_left">修改管理员</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td align="left" class="td4"><asp:Literal ID="L_stat" runat="server"></asp:Literal>
                                    &nbsp;</td>
                </tr>
                 <tr>
