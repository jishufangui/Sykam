<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mod.aspx.cs" Inherits="Web.operate.Shop_Mod" ValidateRequest="false" %>
...
<body>
 ...
 <br />
            <table cellpadding="3" cellspacing="1" border="0" width="100%" align="center">
                <tr>
                    <td colspan="2" class="td_left">修改商户信息</td>
                </tr>
                <tr>
                        ...
                        <asp:TextBox ID="tbx_title" runat="server" 
                             ValidationGroup="2" Width="200px" Height="20px"></asp:TextBox>
                                    &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbx_title"
                                        Display="Dynamic" ErrorMessage="必须输入商户名称" ValidationGroup="2"></asp:RequiredFieldValidator>&nbsp;请输入商户名称&nbsp; &nbsp;<asp:Literal ID="L_IsRecoom" runat="server"></asp:Literal><span style=" color:Red;">作为推荐商户(点击作为推荐商户)</span></td>
                </tr>
                 <tr>
    ...
    &nbsp;gif/jpeg/jpg/png/bmp 小于5M <span id='viewpic'></span>
                 ...
                 <tr>
                    ...
                    </select>&nbsp;<select id="Sel_City" class="diqu" name="Sel_City"><asp:Literal ID="L_City"
                        runat="server"></asp:Literal></option>
                    </select>&nbsp;<select id="Sel_Area" class="diqu" name="Sel_Area"><asp:Literal ID="L_Area"
                        runat="server"></asp:Literal></option>
                    </select></td>
                </tr>
                <tr>
