<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shop_List.aspx.cs" Inherits="Web.operate.Shop_List"  ValidateRequest="false" %>
...
<body>
 ...
 <table cellpadding="3" cellspacing="1" border="0" width="100%" align="center">
                    <tr>
                        <td class="td_title" height="25">商铺管理</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="td5" height="23">
                            ...
                            <a href="Shop_Add.aspx">[添加商铺]</a>
                            <a href="Shop_List.aspx">[商铺列表]</a>
                </td>
                    </tr>
                         <tr>
                        <td class="td5" height="23">
         ...
         <br />
            <table cellpadding="3" cellspacing="1" border="0" width="100%" align="center" class="td4">
                <tr>
                    <td style="height: 30px;" class="td_left">商铺管理&nbsp;<asp:Label ID="lbl_CurrentNode" runat="server" ForeColor="#006600"></asp:Label></td>
                </tr>
                <tr>
                      ...
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellSpacing="1" CellPadding="3"  BackColor="#CCCCCC" GridLines="None"  Width="100%" ForeColor="#333333" OnRowDeleting="GridView1_RowDeleting"   OnRowDataBound="GridView1_RowDataBound"  >
                            ...
                            <HeaderTemplate>
                             ...
                             <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="商铺名称">
                                   
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("ShopTitle") %>'></asp:Label>
                                    ...
                                    <ItemTemplate>
                                        <asp:Literal ID="L_address" runat="server"></asp:Literal>
                                          <asp:HiddenField ID="H_Province" runat="server" Value='<%# Bind("ShopProvince") %>' />
                                          <asp:HiddenField ID="H_City" runat="server" Value='<%# Bind("ShopCity") %>' />
                                          <asp:HiddenField ID="H_area" runat="server" Value='<%# Bind("ShopArea") %>' />
                                    </ItemTemplate>
                                    <ItemStyle CssClass="td4line" Width="20%" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="编辑商铺">
                                    <ItemStyle CssClass="td4line" />
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("ShopID", "Shop_Mod.aspx?id={0}") %>'
