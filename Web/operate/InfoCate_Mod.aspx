<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InfoCate_Mod.aspx.cs" Inherits="Web.operate.InfoCate_Mod" ValidateRequest="false" %>
                        ...
                        <asp:TextBox ID="tbx_title" runat="server" 
                             ValidationGroup="2" Width="200px" Height="20px"></asp:TextBox>
                                    &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbx_title"
                                        Display="Dynamic" ErrorMessage="必须输入频道名称" ValidationGroup="2"></asp:RequiredFieldValidator>&nbsp;请输入类型名称&nbsp; &nbsp;<asp:Literal ID="L_IsRecoom" runat="server"></asp:Literal><span style=" color:Red;">作为推荐频道(点击作为推荐频道)</span></td>
                </tr>
                 <tr>
