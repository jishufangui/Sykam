...
{
    public partial class ReWriteCommonPage
    {
        ...
        public string GetShowPageStr(bool bolCount, bool bolPage, bool bolFirst, bool bolLast, bool bolTurn, bool IsChinese, int intStyle, int intShowNum)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        _FirstStr2 = "<a href=\"" + _TurnUrlStr + "_P" + ".aspx\"  class=\"page_\">" + _FirstStr + "</a>";
                        _PrevStr2 = "<a href=\"" + _TurnUrlStr + "_P" + Convert.ToString(_PageIndex - 1) + ".aspx\" class=\"page_\">" + _PrevStr + "</a>";
                    }
                    ...
                    {
                        _NextStr2 = "<a href=\"" + _TurnUrlStr + "_P" + Convert.ToString(_PageIndex + 1) + ".aspx \" class=\"page_\">" + _NextStr + "</a>";
                        _LastStr2 = "<a href=\"" + _TurnUrlStr + "_P" + _PageCounts + ".aspx \" class=\"page_\">" + _LastStr + "</a>";
                    }
                    ...
                    if (intStyle == 2)
                    {
                        ...
                        if (_PageIndex > _PageCounts - intShowNum + 1)
                        {
                            ...
                            for (int i = 1; i <= intShowNum; i++)
                            {
                                ...
                                {
                                    strPageNum = strPageNum + "<a href=\"" + _TurnUrlStr + "_P" + strTempNow + ".aspx  \">" + strTempNow + "</a> ";
                                }
                            }
                        }
                        else
