...
namespace CommonLibrary
{
    ...
    public class RandomObject
    {
        ...
        {
            char[] arrChar = new char[]{'a','b','d','c','e','f','g','h','i','j','k','l','m','n','p','r','q','s','t','u','v','w','z','y','x','_','A','B','C','D','E','F','G','H','I','J','K','L','M','N','Q','P','R','T','S','V','U','W','X','Y','Z'};
            StringBuilder num = new StringBuilder();
        ...
        #region RNGRandomText

        /// <summary>
        /// Generates an 4 letter random text.
        /// </summary>
        public static string RNGRandomText( int min , int max )
        {
            // Generate random text
            string s = "";
            char[] chars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".ToCharArray();
            int index;
            int lenght = RNG.Next( min , max );
        ...
        /// Generates an 4 letter random text.
        /// </summary>
        public static char[] RNGRandomCharArray( int min , int max )
        {
            // Generate random text
