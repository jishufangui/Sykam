<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Info_Mod.aspx.cs" Inherits="Web.operate.Info_Mod" ValidateRequest="false" %>
     ...
     <script type="text/javascript" src="../ckfinder/ckfinder.js"></script>
          ...
          function() {
             ...
             function() {
              ...
              //$("#tbx_ShopID").autocomplete(emails,
                     {max: 12,    //列表里的条目数
...
<div>
<asp:Literal ID="L_js" runat="server"></asp:Literal>
 ...
 <br />
            <table cellpadding="3" cellspacing="1" border="0" width="100%" align="center">
                <tr>
                    <td colspan="2" class="td_left">修改信息</td>
                </tr>
                  <tr>
                    <td align="center" class="td5" style="width:141px">信息类型</td>
                    <td align="left" class="td4">
                     <asp:Literal ID="L_selinfotype" runat="server"></asp:Literal>
                     </td>
                </tr>
                <tr>
                        ...
                        <asp:TextBox ID="tbx_title" runat="server" 
                             ValidationGroup="2" Width="200px" Height="20px"></asp:TextBox>
                                    &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbx_title"
                                        Display="Dynamic" ErrorMessage="必须输入信息标题" ValidationGroup="2"></asp:RequiredFieldValidator>&nbsp;请输入信息标题&nbsp; &nbsp;<asp:Literal ID="L_IsRecoom" runat="server"></asp:Literal><span style=" color:Red;">作为推荐信息</span></td>
                </tr>
                 <tr>
    ...
    &nbsp;gif/jpeg/jpg/png/bmp 小于5M <span id='viewpic'></span>
                 ...
                 <tr class='dazhe'>
                    ...
                    <td align="left" class="td4"><asp:TextBox ID="tbx_brand" Text="暂无品牌信息"  runat="server"></asp:TextBox><asp:Literal ID="L_brandid" runat="server"></asp:Literal></td>
                </tr>
                ...
                <tr class='dazhe' style="display:none">
                    ...
                    <td align="left" class="td4"><asp:TextBox ID="tbx_ShopID" runat="server" 
                             ValidationGroup="2" Width="200px" Text="暂无商家"></asp:TextBox><asp:Literal ID="L_shopid" runat="server"></asp:Literal>
                                    &nbsp;</td>
                </tr>
                <tr class='dazhe' style="display:none">
                    <td align="center" class="td5" style="width: 141px">活动起始时间</td>
                    <td align="left" class="td4"><asp:TextBox ID="Tbx_BeginTime" runat="server" 
                             ValidationGroup="2" Width="200px" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate"></asp:TextBox>
                                    &nbsp;</td>
                </tr>
                  <tr class='dazhe' style="display:none">
                ...
                <tr>
                    ...
                    <td align="left" class="td4"><asp:TextBox ID="Tbx_Addtime" runat="server"   ReadOnly="true"
                              Width="200px" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="Wdate"></asp:TextBox>
                                    &nbsp;</td>
                </tr>
                    <tr>
                    <td align="center" class="td5" style="width: 141px">修改人</td>
                    <td align="left" class="td4"><asp:TextBox ID="Tbx_modifier" runat="server"   
                              Width="200px" ReadOnly="true"></asp:TextBox><asp:HiddenField ID="H_Modifier"  runat="server"/>
                                    &nbsp;</td>
                </tr>
                
                <tr>
                    <td align="center" class="td5" style="width: 141px">修改时间</td>
                    <td align="left" class="td4"><asp:TextBox ID="Tbx_modifytime" runat="server"  ReadOnly="true"
                              Width="200px" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="Wdate"></asp:TextBox>
                                    &nbsp;</td>
                </tr>
                  <tr>
                ...
                <tr>
                    <td colspan="2"  class="td_left">
                        <asp:Button ID="Button1" runat="server" 
                            Text="未审核提交"  Visible="false"  ValidationGroup="2" CssClass="button5" Width="107px" onclick="Button1_Click" 
                             />
